  ...
  return ( 
    <div className="relative min-h-screen bg-white font-[var(--font-geist-sans)]">
      ...
      <div className="relative z-10 flex flex-col lg:grid lg:grid-cols-2 gap-8 px-6 md:px-20 pt-[86px] items-start">
        ...
        <div className="w-full max-w-[875px] font-light text-[24px] leading-[140%] text-[#000066] flex flex-col justify-start px-4 pb-[100px]">
          <p className="text-[24px] font-light leading-[140%] text-[#000000]">
